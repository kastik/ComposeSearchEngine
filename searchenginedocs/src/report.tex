...
\begin{document}
    ...
    \begin{thebibliography}{00}
        \bibitem{b1} \href{https://github.com/kastik/ComposeSearchEngine}{GitHub Repository for ComposeSearchEngine}
        \bibitem{b2} \href{https://github.com/kastik/ComposeSearchEngine/blob/master/searchenginedocs/src/ai.log}{AI Logs}
        \bibitem{b3} \href{https://archlinux.org/packages/extra/any/arch-wiki-docs/}{Data Source}
    \end{thebibliography}
    \vspace{12pt}
\end{document}
